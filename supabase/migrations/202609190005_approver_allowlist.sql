-- Valte v2 approver allowlist: enforce approver_entity_ids for human_required pending_approval actions
-- Extends replace_plan branch to return invalid_approver when allowlist missing, non-unique, or unknown entity
